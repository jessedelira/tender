...
const TopTen = () => {
    ...
    //Likely do a query of the DB getting the top 10 resturaunts based on user ratings.
    const myResturaunts = [
        {key: 1, name: "Umi", rating: 4.2},
        {key: 2, name: "Don Hall's", rating: 4.1},
        {key: 3, name: "Firehouse Subs", rating: 4}
      ];
    ...
    const renderTopTen = (resturaunt, index) => {
        return(
            <section class="1" variant="dark">
                    ...
                    <h4>Rating: {resturaunt.rating}</h4>
                    <br />
